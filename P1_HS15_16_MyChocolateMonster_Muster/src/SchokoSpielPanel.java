...
public class SchokoSpielPanel extends JPanel implements MouseMotionListener, SimpleTimerListener {
	...
	private Figur[] schokos = new Figur[100];// fehlt in Vorlage
	private Image hgBild;// fehlt in Vorlage
	private SimpleTimer timer;
	private double xIst, xSoll, yIst, ySoll;
	private int level;

	//Figur figur = new Figur(0);
	 ...
	 * - Erzeugt den SimpleTimer timer mittels new SimpleTimer(50, this) und startet in.
	 * </pre>
	 */
	...
	public void paintComponent(Graphics g) {
		...
		// 5
//      figur.anzeigen(g);//eigentlich besser um KLasse Figur zu testen
//	    g.drawImage(figur.bild, 50, 150, null);
