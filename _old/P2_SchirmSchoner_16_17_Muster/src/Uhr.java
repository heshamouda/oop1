...
public class Uhr extends GrafikObjekt {
	...
	private AudioClip[] strikesClip = new AudioClip[12];
	...
	public Uhr(int xZeiger, int yZeiger, int breite, int hoehe) {
		...
		for (int i = 0; i < strikesClip.length; i++) {
			strikesClip[i] = Utility.loadAudioClip("Strikes_" + i + ".wav");
		}
